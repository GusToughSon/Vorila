...
//	memset(&UsedSlot, 0, sizeof(UsedSlot));
	...
	textlinks->NewTextlink("5min", 550, 75, 12, BFont_TextWidth("5min"), 6, 100001);
	textlinks->NewTextlink("10min", 590, 75, 12, BFont_TextWidth("10min"), 7, 100001);
	textlinks->NewTextlink("20min", 630, 75, 12, BFont_TextWidth("20min"), 8, 100001);
	textlinks->NewTextlink("30min", 670, 75, 12, BFont_TextWidth("30min"), 9, 100001);
	textlinks->NewTextlink("60min", 710, 75, 12, BFont_TextWidth("60min"), 10, 100001);

	textlinks->NewTextlink("Jail", 470, 90, 12, BFont_TextWidth("Jail"), 1, 100002);
	textlinks->NewTextlink("UnJail", 500, 90, 12, BFont_TextWidth("UnJail"), 2, 100002);

	mtextlinks->NewTextlink("Online list", 540, 10, 12, BFont_TextWidth("Online list"), 3, 100003);
	mtextlinks->NewTextlink("Spawn mobs", 640, 10, 12, BFont_TextWidth("Spawn mobs"), 4, 100004);
	mtextlinks->NewTextlink("Spawn item", 540, 30, 12, BFont_TextWidth("Spawn item"), 5, 100005);

	spmodelinks->NewTextlink("Spawn them!", 435, 550, 12, BFont_TextWidth("Spawn them!"), 11, 100006);
	simodelinks->NewTextlink("Create Item!", 435, 550, 12, BFont_TextWidth("Create Item!"), 12, 100007);
