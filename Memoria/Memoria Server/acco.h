...
public:
	...
	Account *GetByName(char *Name);
	Account *GetByPass(char *Pass);
	//Account *GetByEmail(char *Email);
	Account *GetByID(ULONG ID);
	Account *GetByCharName(char *Name);
...
public:
	...
	BOOL ComparePass(char *Pass);
	//BOOL CompareEmail(char *Email);
	bool CompareID(unsigned long ID);
	CharacterData *CompareCharName(char *Name);
