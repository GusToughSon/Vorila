...
/*	if (DoArchiveSave)
	{
		...
		sprintf(Folder, "Eldoria Save %d-%d-%d-%d", SYS->Timer->CurrentTime.wHour, SYS->Timer->CurrentTime.wDay, SYS->Timer->CurrentTime.wMonth, SYS->Timer->CurrentTime.wYear);
...
Account *AccountManager::GetByName(char *Name)
{
	Account *tmp;
	tmp = Accs;
	while (tmp)
...
Account *AccountManager::GetByPass(char *Pass)
{
	Account *tmp;
	tmp = Accs;
	while (tmp)
...
Account *AccountManager::GetByCharName(char *Name)
{
	Account *tmp;
	tmp = Accs;
	while (tmp)
...
CharacterData *Account::CompareCharName(char *Name)
{
...
BOOL Account::CompareName(char *Name)
{
...
BOOL Account::ComparePass(char *Pass)
{
